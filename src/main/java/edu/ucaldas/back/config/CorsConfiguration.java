...
/**
 * Spring configuration class for setting up Cross-Origin Resource Sharing
 * (CORS) in the application.
 * <p>
 * This class implements {@link WebMvcConfigurer} to customize CORS mappings,
 * allowing the frontend
 * running on <code>http://localhost:8080</code> to interact with the backend.
 * It enables HTTP methods
...
public class CorsConfiguration implements WebMvcConfigurer {
     ...
     * <p>
     * This method allows HTTP requests from the specified origin
     * ("http://localhost:8080")
     * to access resources on the server. It permits the HTTP methods GET, POST,
     * PUT, and DELETE
     * for all endpoints ("/**").
     *

 ...
 * This class is annotated as a JPA entity and maps to the "house" table in the
 * database.
 * It contains information about a house, including its description, address,
 * owner, reviews, images, and availability status.
 * 
 * <p>
 * Annotations:
 * <ul>
 ...
 * <li>@Getter, @Setter - Lombok annotations to generate getter and setter
 * methods.</li>
 * <li>@NoArgsConstructor, @AllArgsConstructor - Lombok annotations to generate
 * constructors.</li>
 * <li>@EqualsAndHashCode(of = "id") - Lombok annotation to generate equals and
 * hashCode methods based on the "id" field.</li>
 * </ul>
 * </p>
 * 
 * <p>
 ...
 * <li>address - The address of the house, represented as an embedded
 * object.</li>
 * <li>owner - The user who owns the house. It is a many-to-one
 * relationship.</li>
 * <li>reviews - A list of reviews associated with the house. It is a
 ...
 * <li>images - A list of images associated with the house. It is a one-to-many
 * relationship.</li>
 ...
 * <li>House(long id, String description, address address, User owner,
 * List<HouseReview> reviews, float stars, boolean isAvailable,
 * List<HouseImages> images, boolean isActive) - All-argument constructor
 * generated by Lombok.</li>
 * <li>House(HouseData houseData, User owner) - Custom constructor to initialize
 * a house with data from a HouseData object and an owner.</li>
 * </ul>
 * </p>
 */
@Entity
